...
class MLPSimplifiedNumClassification(nn.Module):
    """
    ...
    def __init__(self):
        ...
        self.fc1 = nn.Linear(3 * 100 * 100, 64) # 第一个全连接层，输入为28*28，输出为128
        self.fc2 = nn.Linear(64, 32) # 第二个全连接层，输入为128,输出为64
        self.fc3 = nn.Linear(32, 11) # 第三个全连接层，也是输出层，输入为64，输出为10，对应10个数字
